...
#ifndef KANOLI_FLUTTER_SWIFT_H
#define KANOLI_FLUTTER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="kanoli_flutter",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC14kanoli_flutter11AppDelegate")
...
SWIFT_CLASS("_TtC14kanoli_flutter17MainFlutterWindow")
