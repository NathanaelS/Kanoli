...
1. Open Kanoli and click **Create File** to start a new Markdown board.
2. Click **Open File** to load an existing board.
3. Click **Import Trello Board** to convert Trello JSON into a Kanoli Markdown board.
